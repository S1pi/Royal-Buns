...
const resp = () => {
  ...
  contentContainer.classList.add('flex', 'h-5/6', 'respPhotoTextContainer');

  const textContainer = document.createElement('div');
  textContainer.classList.add('flex-1', 'justify-left', 'p-5', 'respTextContainer');
  ...
  heading.classList.add('text-6xl', 'respHeading');
  heading.textContent = 'VASTUULLISUUS';

  const p = document.createElement('p');
  p.classList.add('text-lg', 'text-black', 'whitespace-pre-line', 'respText');
